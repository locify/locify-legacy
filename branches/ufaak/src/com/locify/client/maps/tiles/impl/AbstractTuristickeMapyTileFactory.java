 ...
 * @author ufaak
 */
public class AbstractTuristickeMapyTileFactory extends AbstractTileFactory {
    /**
     * Creates a new instance of TileFactory
     */
    public AbstractTuristickeMapyTileFactory(MapLayer canvasToRepaintWhenLoaded, String provider, String mode, String baseUrl) {
