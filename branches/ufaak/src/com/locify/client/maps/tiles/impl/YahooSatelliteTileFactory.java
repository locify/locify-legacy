...
public class YahooSatelliteTileFactory extends AbstractYahooTileFactory {
 	    public YahooSatelliteTileFactory(MapLayer canvasToRepaintWhenLoaded) {
 	        super(canvasToRepaintWhenLoaded, "Yahoo", "Satellite", "http://us.maps3.yimg.com/aerial.maps.yimg.com/ximg?v=1.7&t=a");
	    }
 	}
