...
//System.out.println("\n " + "file:///" + FileSystem.ROOT + FileSystem.FILES_FOLDER + fileName);
            fileConnection = R.getFileSystem().getFileConnection(FileSystem.ROOT + FileSystem.FILES_FOLDER + fileName);
...
//System.out.println("\n " + fileName);
            ...
            FileSystem.quiteClose(fileConnection);
            FileSystem.quiteClose(is);
        }
    }
