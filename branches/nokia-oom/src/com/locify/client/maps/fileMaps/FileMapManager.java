        ...
        /* LOCAL maps (single or multi) */
            ...
            try {
                ...
                if (R.getFileSystem().exists(mapPathAbsolute)) {
                    ...
                    dir = R.getFileSystem().getFileConnection(ffDirName);
...
//Logger.debug("  FileMapManager.getMapType() - " + mapPathAbsolute);
                FileConnection connection = R.getFileSystem().getFileConnection(mapPathAbsolute);
...
//Logger.debug("Data: rec: " + record.toString() + " data: " + data);
    ...
    private void calculateTileSize() {
        ...
        if (storageTar != null) {
            ...
            try {
                con = R.getFileSystem().getFileConnection(mapPath + createImageName(0, 0));
