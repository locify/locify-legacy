...
public class VirtualEarthAerialTileFactory extends AbstractVirtualEarthTileFactory {
    ...
    public VirtualEarthAerialTileFactory(MapLayer canvasToRepaintWhenLoaded) {
        super(canvasToRepaintWhenLoaded, "Microsoft", "Aerial", "http://tiles.virtualearth.net/tiles/a");
    }
}
