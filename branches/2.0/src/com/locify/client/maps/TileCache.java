...
//    private int maxCacheTiles;
    ...
    private Hashtable runningHttpDownloaders;
...
//Logger.log("Actual size: " + actualCacheTileSizeFilesystem);
        ...
        this.runningHttpDownloaders = new Hashtable();
...
//Logger.log("New request: " + actualR.fileName);
            ...
            Enumeration enu = runningHttpDownloaders.keys();
            while (enu.hasMoreElements()) {
                String key = (String) enu.nextElement();
                HttpImageDownloader hid = (HttpImageDownloader) runningHttpDownloaders.get(key);
                if (!existInRequest(hid.path)) {
                    runningHttpDownloaders.remove(key);
                }
            }
