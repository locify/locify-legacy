...
public class LocationContext implements LocationEventGenerator {
    ...
    public LocationContext() {
        ...
        commands[GPS] = new Command(Locale.get("Gps"), 10);
        commands[SAVED_LOCATION] = new Command(Locale.get("Saved_location"), 11);
        commands[ADDRESS] = new Command(Locale.get("Address"), 12);
        commands[COORDINATES] = new Command(Locale.get("Coordinates"), 13);
        commands[LAST_KNOWN] = new Command(Locale.get("Last_known"), 14);
