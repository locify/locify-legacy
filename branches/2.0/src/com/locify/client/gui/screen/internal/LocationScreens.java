...
public class LocationScreens implements ActionListener {
    ...
    public void viewCoordinatesScreen() {
        ...
        tfLatitude = new TextArea(GpsUtils.formatLatitude(R.getLocator().getLastLocation().getLatitude()), 1, 100, TextArea.ANY);
        form.addComponent(tfLatitude);

        Label labelLon = new Label(Locale.get("Longitude"));
        form.addComponent(labelLon);
        tfLongitude = new TextArea(GpsUtils.formatLongitude(R.getLocator().getLastLocation().getLongitude()), 1, 100, TextField.ANY);
