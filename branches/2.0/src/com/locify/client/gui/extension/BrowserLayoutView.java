 ...
 */
////public class BrowserLayoutView extends ContainerView {
////
////    static private final int LAYOUT_HORIZONTAL = Item.LAYOUT_LEFT | Item.LAYOUT_CENTER | Item.LAYOUT_RIGHT;
////    static private final int LAYOUT_VERTICAL = Item.LAYOUT_TOP | Item.LAYOUT_VCENTER | Item.LAYOUT_BOTTOM;
////
//////        class RowItem {
//////                int x;
//////                int y;
...
////
////        if (Item.LAYOUT_NEWLINE_BEFORE == (itemLayout & Item.LAYOUT_NEWLINE_BEFORE) || (this.rowWidth + this.paddingHorizontal + width > lineWidth)) {
...
////        Item paintLaterItem = null;
////        int[] laterParams = null;
...
////                    if (rowItem.getAttribute("select") != null) {
////                        popupOpened = !((ChoiceGroup) rowItem).isPopupClosed();
////                    }
////                    if (popupOpened) {
////                        //remember values of opened popup
////                        paintLaterItem = rowItem;
////                        laterParams = new int[9];
////                        laterParams[0] = i;
////                        laterParams[1] = xItem;
////                        laterParams[2] = y + rowItem.relativeY;
////                        laterParams[3] = Math.max(leftBorder, xItem);
////                        laterParams[4] = Math.min(rightBorder, xItem + rowItem.itemWidth);
////                        laterParams[5] = clipX;
////                        laterParams[6] = clipY;
////                        laterParams[7] = clipWidth;
////                        laterParams[8] = clipHeight;
////                    } else {
...
////            }
////        }
////        //paint opened popup at the end
////        if (paintLaterItem != null)
////        {
////            paintItem(paintLaterItem, laterParams[0], laterParams[1], laterParams[2], laterParams[3], laterParams[4], laterParams[5], laterParams[6], laterParams[7], laterParams[8], g);
////        }
////    }
////
////    /*
...
////            while (rowIndex > 0) {
////                rowIndex--;
////                item = getItemByHorizontalOffset((ArrayList) this.allRows.get(rowIndex), this.horizontalOffset);
////                if (item != null) {
////                    break;
////                }
////            }
...
////            if (screen != null && focItem != null && (gameAction == Canvas.DOWN || gameAction == Canvas.RIGHT) && (item.relativeY - focItem.relativeY + (focItem.relativeY + this.parentContainer.getRelativeScrollYOffset()) > screen.getScreenContentHeight())) {
