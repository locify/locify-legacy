...
//#     public static Command cmdPlanStudio;
    ...
    public static void initializeCommands() {
        ...
        cmdDelete = new Command(Locale.get("Delete"), ResourcesLocify.getImage("delete"), 5);
        cmdExit = new Command(Locale.get("Exit"), ResourcesLocify.getImage("exit"), 3);
        cmdHome = new Command(Locale.get("Home"), ResourcesLocify.getImage("home"), 50);
        ...
        cmdSelect = new Command(Locale.get("Select"), ResourcesLocify.getImage("select"), 0);
        ...
        // commands only for mainScreen
        cmdAdd = new Command(Locale.get("Add"), ResourcesLocify.getImage("add"), 13);
        cmdAddByLink = new Command(Locale.get("Service_by_link"), ResourcesLocify.getImage("addFromLink"), 11);
        cmdAddService = new Command(Locale.get("Service_from_list"), ResourcesLocify.getImage("addFromList"), 10);
        cmdMoreInfo = new Command(Locale.get("More_info"), ResourcesLocify.getImage("moreInfo"), 10);
        cmdMove = new Command(Locale.get("Move"), ResourcesLocify.getImage("move"), 14);
        cmdMoveTo = new Command(Locale.get("Move"), 1);
        cmdRename = new Command(Locale.get("Rename"), ResourcesLocify.getImage("renameService"), 13);
        cmdService = new Command(Locale.get("Service"), 11);
        cmdServiceSettings = new Command(Locale.get("Settings"), ResourcesLocify.getImage("serviceSettings"), 11);
        cmdShortcut = new Command(Locale.get("Shortcut"), 11);
        cmdUpdateService = new Command(Locale.get("Update_service"), ResourcesLocify.getImage("updateService"), 12);
