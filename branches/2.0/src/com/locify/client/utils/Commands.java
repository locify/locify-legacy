...
public class Commands {
    ...
    /** ID for commands that will not be shown in right menu */
    public static int RIGHT_COMMAND_ID = 1001;
    ...
    public static void initializeCommands() {
        ...
        cmdBack = new Command(Locale.get("Back"), RIGHT_COMMAND_ID);
        ...
        cmdDelete = new Command(Locale.get("Delete"), 5);
        cmdExit = new Command(Locale.get("Exit"), RIGHT_COMMAND_ID);
        cmdHome = new Command(Locale.get("Home"), 50);
        ...
        cmdSelect = new Command(Locale.get("Select"), 0);
        ...
        // commands only for mainScreen
        cmdAdd = new Command(Locale.get("Add"), 13);
        cmdAddByLink = new Command(Locale.get("Service_by_link"), 11);
        cmdAddService = new Command(Locale.get("Service_from_list"), 10);
        cmdMoreInfo = new Command(Locale.get("More_info"), 10);
        cmdMove = new Command(Locale.get("Move"), 14);
        cmdMoveTo = new Command(Locale.get("Move"), 1);
        cmdRename = new Command(Locale.get("Rename"), 13);
        cmdService = new Command(Locale.get("Service"),11);
        cmdServiceSettings = new Command(Locale.get("Settings"), 11);
        cmdShortcut = new Command(Locale.get("Shortcut"), 11);
        cmdUpdateService = new Command(Locale.get("Update_service"), 12);
