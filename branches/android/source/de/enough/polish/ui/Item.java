...
//			}
		...
		//#ifdef polish.css.min-width
			Dimension minWidthInt = (Dimension) style.getObjectProperty(58);
			if (minWidthInt != null) {
				this.minimumWidth = minWidthInt;
			}
		//#endif
		//#ifdef polish.css.max-width
			Dimension maxWidthInt  = (Dimension) style.getObjectProperty(59);
			if (maxWidthInt != null) {
				this.maximumWidth = maxWidthInt;
			}
		//#endif
		//#ifdef polish.css.min-height
			//# Dimension minHeightInt = (Dimension) style.getObjectProperty(144);
			//# if (minHeightInt != null) {
				//# this.minimumHeight = minHeightInt;
			//# }
		//#endif
		//#ifdef polish.css.max-height
			//# Dimension maxHeightInt  = (Dimension) style.getObjectProperty(145);
