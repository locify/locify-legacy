 ...
 */
	public class VirtualEarthHybridTileFactory extends AbstractVirtualEarthTileFactory {
	    public VirtualEarthHybridTileFactory(MapLayer canvasToRepaintWhenLoaded) {
 	        super(canvasToRepaintWhenLoaded, "Microsoft", "Hybrid", "http://tiles.virtualearth.net/tiles/h");
	    }
 	}
