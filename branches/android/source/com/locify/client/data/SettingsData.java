...
public class SettingsData {
    ...
    public final String[] languageNames = {Locale.get(215), Locale.get(214)};    //settings
    ...
    public void load() {
        try {
            R.getLoading().setText(Locale.get(82));
            //default settings
            ...
            settings.put("locationInfo", Locale.get(506));
    ...
    public void saveLocationSettings(int prefferedGps, int coordinatesFormat) {
        ...
        saveXML();
        R.getCustomAlert().quickView(Locale.get(280), Locale.get(66), "locify://refresh");
    }
    ...
    public void saveInterfaceSettings(int selectedLanguage, int units, int backlight, int backlightFrequency) {
        try {
            ...
            saveXML();
            R.getCustomAlert().quickView(Locale.get(479), Locale.get(66), "locify://refresh");
        } catch (Exception e) {
