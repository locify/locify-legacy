...
public class XHTMLTagHandler
    ...
    //#ifdef polish.i18n.useDynamicTranslations
		public static Command CMD_LINK = new Command( Locale.get(179), Command.OK, 2 );
    ...
    //#ifdef polish.i18n.useDynamicTranslations
		public static Command CMD_SUBMIT = new Command( Locale.get(185), Command.ITEM, 2 );
    ...
    //#ifdef polish.i18n.useDynamicTranslations
		public static Command CMD_BACK = new Command( Locale.get(174), Command.BACK, 10 );
    ...
    public XHTMLTagHandler() {
        //#ifdef polish.i18n.useDynamicTranslations
	  	if (Locale.get(179) != CMD_LINK.getLabel()) {
	  		CMD_LINK = new Command( Locale.get(179), Command.OK, 2 );
	  		CMD_SUBMIT = new Command( Locale.get(185), Command.ITEM, 2 );
	  		CMD_BACK = new Command( Locale.get(174), Command.BACK, 10 );
	  	}
        //#endif
    }
        ...
        try {
            ...
            if (opening) {
                if (TAG_TITLE.equals(tagName)) {
                    ...
                    //#style breakline
                    StringItem stringItem = new StringItem(null, null, de.enough.polish.ui.StyleSheet.breaklineStyle );
                    add(stringItem);
                    return true;
                    ...
                    //#style button
                    StringItem buttonItem = new StringItem(null, value, de.enough.polish.ui.StyleSheet.buttonStyle );
                    if (style != null) {
                    ...
                    if (this.currentForm != null) {
                        ...
                        if (INPUTTYPE_TEXT.equals(type)) {
                            //#style textfield
                            TextField textField = new TextField(labelText, value, 1000, TextField.ANY, de.enough.polish.ui.StyleSheet.textfieldStyle );
                            if (style != null) {
                                textField.setStyle(style);
                            }
                            add(textField);
                            ...
                            if (!value.equals("")) {
                                try {
                                    ...
                                    if (originalValue.equals("$lat")) {
                                        R.getCustomAlert().quickView(Locale.get(165), "Warning", "locify://refresh");
                                    } else {
                                        R.getCustomAlert().quickView(Locale.get(166), "Warning", "locify://refresh");
                                    }
