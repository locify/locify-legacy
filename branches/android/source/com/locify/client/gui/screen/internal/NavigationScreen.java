...
public class NavigationScreen extends Form implements CommandListener, LocationEventListener {
    ...
    public NavigationScreen() {
        ...
        super(Locale.get(107));
        try {
            cmdMore = new Command(Locale.get(525), Command.ITEM, 2);
            cmdLess = new Command(Locale.get(524), Command.ITEM, 3);
            ...
            //#style imgMore
            addCommand(cmdMore, de.enough.polish.ui.StyleSheet.imgmoreStyle );
            ...
            //#style imgHome
            addCommand(Commands.cmdHome, de.enough.polish.ui.StyleSheet.imghomeStyle );
    ...
    private void initializeItems() {
        if (items == null) {
            ...
            // ITEM_ROUTE_TIME
            ScreenItem button00 = new ScreenItem(Locale.get(43));
            items.add(button00);
            // ITEM_ROUTE_DIST
            ScreenItem button01 = new ScreenItem(Locale.get(140));
            items.add(button01);
            // ITEM_SPEED_MAX
            ScreenItem button02 = new ScreenItem(Locale.get(73));
            items.add(button02);
            // ITEM_SPEED_AVERAGE
            ScreenItem button03 = new ScreenItem(Locale.get(87));
            items.add(button03);
            // ITEM_SPEED_ACTUAL
            ScreenItem button04 = new ScreenItem(Locale.get(11));
            items.add(button04);
            // ITEM_LATITUDE
            ScreenItem button05 = new ScreenItem(Locale.get(3));
            items.add(button05);
            // TIME
            ScreenItem button06 = new ScreenItem(Locale.get(442));
            items.add(button06);
            // DATE
            ScreenItem button07 = new ScreenItem(Locale.get(526));
            items.add(button07);
