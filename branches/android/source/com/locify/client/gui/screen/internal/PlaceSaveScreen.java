...
public class PlaceSaveScreen {
    ...
    public void view() {
        ...
        R.getHTMLScreen().setTitle(Locale.get(389));
        ...
        R.getHTMLScreen().addTextField(Locale.get(92), "name", "");
        R.getHTMLScreen().addNewLine();
        R.getHTMLScreen().addTextField(Locale.get(41), "description", "");
        R.getHTMLScreen().addButton(Locale.get(126), "save", "");
