...
public class MapScreen extends Screen implements CommandListener, LocationEventListener, Runnable {
    ...
    public MapScreen() {
        ...
        cmdMapFunction = new Command(Locale.get(513), Command.SCREEN, 1);
        cmdZoomIn = new Command(Locale.get(276), Command.SCREEN, 2);
        cmdZoomOut = new Command(Locale.get(277), Command.SCREEN, 3);
        cmdMyLocation = new Command(Locale.get(278), Command.SCREEN, 4);
        cmdChangeMapTile = new Command(Locale.get(328), Command.SCREEN, 5);
        cmdChangeMapFile = new Command(Locale.get(327), Command.SCREEN, 6);
        cmdItemManager = new Command(Locale.get(512), Command.SCREEN, 7);
        //#if planstudio
        ...
        if (providers.size() > 0) {
            //#style imgOnlineMap
            this.addCommand(cmdChangeMapTile, de.enough.polish.ui.StyleSheet.imgonlinemapStyle );
        ...
        //#style imgSaved
        this.addCommand(cmdChangeMapFile, de.enough.polish.ui.StyleSheet.imgsavedStyle );

        //another location commands
        //#style imgWhere
        this.addCommand(Commands.cmdAnotherLocation, de.enough.polish.ui.StyleSheet.imgwhereStyle );
    ...
    public static Image getImageNotExisted() {
        try {
            if (imageNotExisted == null) {
                imageNotExisted = getImageVarious(Locale.get(330));
            }
    ...
    public static Image getImageLoading() {
        try {
            if (imageLoading == null) {
                imageLoading = getImageVarious(Locale.get(329));
            }
            return imageLoading;
        } catch (Exception e) {
    ...
    public static Image getImageConnectionNotFound() {
        try {
            if (imageConnectionNotFound == null) {
                imageConnectionNotFound = getImageVarious(Locale.get(27));
            }
    ...
    public static Image getImageTooBigSize() {
        try {
            if (imageTooBigSize == null) {
                imageTooBigSize = getImageVarious(Locale.get(453));
            }
