...
public class HTMLScreen implements CommandListener, LocationEventListener {
    ...
    private Command cmdRefresh = new Command(Locale.get(121), Command.SCREEN, 2);
    ...
    public HTMLScreen() {
        ...
        //#style imgWhere
        form.addCommand(Commands.cmdAnotherLocation, de.enough.polish.ui.StyleSheet.imgwhereStyle );
    ...
    public void view(String data) {
        ...
        if (R.getContext().getSource() == LocationContext.GPS) {
            //#style imgGps
            form.addCommand(cmdRefresh, de.enough.polish.ui.StyleSheet.imggpsStyle );
        ...
        if (ServicesData.getCurrent().equals("Locify")) {
            ...
            //#style imgManage
            form.addCommand(R.getMainScreen().cmdService, de.enough.polish.ui.StyleSheet.imgmanageStyle );
            ...
            //#style imgInfo
            UiAccess.addSubCommand(R.getMainScreen().cmdMoreInfo, R.getMainScreen().cmdService, form, de.enough.polish.ui.StyleSheet.imginfoStyle );
            if (!"".equals(ServicesData.getService(ServicesData.getCurrent()).getSettingsUrl())) {
                //#style imgServiceSettings
                UiAccess.addSubCommand(R.getMainScreen().cmdServiceSettings, R.getMainScreen().cmdService, form, de.enough.polish.ui.StyleSheet.imgservicesettingsStyle );
            }
            //#style imgUpdateService
            UiAccess.addSubCommand(R.getMainScreen().cmdUpdateService, R.getMainScreen().cmdService, form, de.enough.polish.ui.StyleSheet.imgupdateserviceStyle );
        }
    ...
    public void addTextField(String label, String name, String value) {
        //#style textfield
        TextField textField = new TextField(label, value, 100, TextField.ANY, de.enough.polish.ui.StyleSheet.textfieldStyle );
    ...
    public void addButton(String label, String name, String value) {
        //#style button
        StringItem buttonItem = new StringItem(null, label, de.enough.polish.ui.StyleSheet.buttonStyle );
