...
public class RouteScreen extends Form implements CommandListener {
    ...
    public void view() {
        if (R.getContext().getSource() != LocationContext.GPS) {
            ...
            if (!alreadyInitialized) {
                ...
                if (initializePaused) {
                    actualizeItems();
                    buttonStart.setTextLabel(Locale.get(429));
                    buttonStart.setActive(true);
    ...
    private void addMenu() {
        cmdBack = new Command(Locale.get(16), Command.BACK, 1);

        cmdStyle = new Command(Locale.get(441), Command.SCREEN, 2);
        cmdStyleSimple = new Command(Locale.get(436), Command.SCREEN, 2);
        cmdStyleExtended = new Command(Locale.get(416), Command.SCREEN, 2);
        cmdStyleGraphs = new Command(Locale.get(419), Command.SCREEN, 2);

        cmdAction = new Command(Locale.get(388), Command.SCREEN, 2);
        cmdActionStart = new Command(Locale.get(437), Command.SCREEN, 2);
        cmdActionStop = new Command(Locale.get(439), Command.SCREEN, 2);
        cmdActionReset = new Command(Locale.get(428), Command.SCREEN, 2);
        cmdActionPause = new Command(Locale.get(426), Command.SCREEN, 2);
        cmdActionResume = new Command(Locale.get(463), Command.SCREEN, 2);
    ...
    private void initializeMainButtons() {
        ...
        // ITEM_BUTTON_START
        buttonStart = new ScreenItem(Locale.get(438));
        ...
        // ITEM_BUTTON_STOP
        buttonStop = new ScreenItem(Locale.get(440));
    ...
    private void initializeItems() {
        if (items == null) {
            ...
            // ITEM_ROUTE_TIME
            ScreenItem button00 = new ScreenItem(Locale.get(442));
            items.add(button00);
            // ITEM_ROUTE_DIST
            ScreenItem button01 = new ScreenItem(Locale.get(43));
            items.add(button01);
            // ITEM_SPEED_MAX
            ScreenItem button02 = new ScreenItem(Locale.get(422));
            items.add(button02);
            // ITEM_SPEED_AVERAGE
            ScreenItem button03 = new ScreenItem(Locale.get(414));
            items.add(button03);
            // ITEM_SPEED_ACTUAL
            ScreenItem button04 = new ScreenItem(Locale.get(140));
            items.add(button04);
            // ITEM_LATITUDE
            ScreenItem button05 = new ScreenItem(Locale.get(73));
            items.add(button05);
            // ITEM_LONGITUDE
            ScreenItem button06 = new ScreenItem(Locale.get(87));
            items.add(button06);
            // ITEM_ALTITUDE
            ScreenItem button07 = new ScreenItem(Locale.get(11));
            items.add(button07);
            // ITEM_HDOP
            ScreenItem button08 = new ScreenItem(Locale.get(420));
            items.add(button08);
            // ITEM_VDOP
            ScreenItem button09 = new ScreenItem(Locale.get(445));
            items.add(button09);
    ...
    private void routeStart() {
        ...
        // visibe buttons
        buttonStart.setTextLabel(Locale.get(427));
        buttonStart.setActive(true);
        buttonStop.setActive(true);
        selected = items.size() - 2;
    ...
    public void routeReset() {
        ...
        buttonStart.setTextLabel(Locale.get(438));
        buttonStart.setActive(true);
        buttonStop.setActive(false);
        selected = items.size() - 2;
