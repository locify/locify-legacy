...
public class AuthenticationScreens implements CommandListener, ItemCommandListener {
    ...
    private Command cmdSelect = new Command(Locale.get(130), Command.ITEM, 10);
    ...
    private void viewLogin(String loginTo, String savedLogin, String savedPassword) {
        try {
            frmLogin = new Form(Locale.get(413));
            StringItem siLoginTo = new StringItem("", Locale.get(32) + " " + loginTo + ":");
            frmLogin.append(siLoginTo);
            tfLogin = new TextField(Locale.get(413), savedLogin, 32, TextField.ANY);
            frmLogin.append(tfLogin);
            tfPassword = new TextField(Locale.get(115), savedPassword, 32, TextField.ANY | TextField.PASSWORD | TextField.NON_PREDICTIVE | TextField.SENSITIVE);
            frmLogin.append(tfPassword);
            cgAuto = new ChoiceGroup("", Choice.MULTIPLE);
            cgAuto.append(Locale.get(127), null);
            cgAuto.append(Locale.get(219), null);
            ...
            siLoginButton = new StringItem("", Locale.get(413), Item.BUTTON);
            ...
            //#style imgHome
            frmLogin.addCommand(Commands.cmdHome, de.enough.polish.ui.StyleSheet.imghomeStyle );
