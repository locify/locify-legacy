...
public class LocationContext implements LocationEventGenerator {
    ...
    public LocationContext() {
        ...
        commands[GPS] = new Command(Locale.get(245), Command.SCREEN, 10);
        commands[SAVED_LOCATION] = new Command(Locale.get(128), Command.SCREEN, 11);
        commands[ADDRESS] = new Command(Locale.get(241), Command.SCREEN, 12);
        commands[COORDINATES] = new Command(Locale.get(242), Command.SCREEN, 13);
        commands[LAST_KNOWN] = new Command(Locale.get(247), Command.SCREEN, 14);
