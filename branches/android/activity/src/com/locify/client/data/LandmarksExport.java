...
import de.enough.polish.android.location.Landmark;
import de.enough.polish.android.location.LandmarkStore;
...
/**
    ...
    public static void export(Waypoint waypoint, String callNext) {
        try {
            ...
            R.getCustomAlert().quickView(Locale.get(231), Locale.get(66), callNext);
        } catch (Exception e) {
