...
public abstract class GeoFiles {
    ...
    public static void save(String kml, String filename) {
        try {
            ...
            //view alert
            R.getCustomAlert().quickView(Locale.get(379), "info", "locify://refresh");
        } catch (Exception e) {
    ...
    public static void saveWaypoint(double latitude, double longitude, String name, String description) {
        try {
            ...
            //view alert
            R.getCustomAlert().quickView(Locale.get(154), "info", "locify://back");
        } catch (Exception e) {
    ...
    public static void saveGeoFileData(String kml) {
        try {
            ...
            if (type != TYPE_CORRUPT && name != null && name.length() > 0) {
                ...
                //view alert
                R.getCustomAlert().quickView(Locale.get(154), "info", "locify://geoFileBrowser");
            }
        } catch (Exception e) {
