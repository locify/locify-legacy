...
public class Geocoding {
    ...
    public static void start(String address) {
        R.getHttp().start("http://local.yahooapis.com/MapsService/V1/geocode?appid=9UbHjo7V34GSlshPrG9uURmEguPRUfT3Nh3H0qDKt_fHZtdNjY3gndp8Vszg&location=" + Utils.urlUTF8Encode(address), Http.GEOCODING);
    }
    ...
    public static void error() {
        R.getCustomAlert().quickView(Locale.get(246), Locale.get(47), "locify://refresh");
    }
}
