...
public class ExternalBrowser implements CommandListener {
    ...
    private Command cmdAlways = new Command(Locale.get(12), Command.SCREEN, 10);
    private Command cmdNever = new Command(Locale.get(108), Command.SCREEN, 11);
    ...
    public void viewCloseAppScreen() {
        frmExternalClose = new Form(Locale.get(50));
        frmExternalClose.append(Locale.get(51));
        ...
        //#style imgHome
        frmExternalClose.addCommand(Commands.cmdHome, de.enough.polish.ui.StyleSheet.imghomeStyle );
