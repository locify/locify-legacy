	...
	extends TagHandler
{
	...
	//#ifdef polish.i18n.useDynamicTranslations
		public static Command CMD_RSS_ITEM_SELECT = new Command( Locale.get(211), Command.OK, 1 );
	...
	//#ifdef polish.i18n.useDynamicTranslations
		public static Command CMD_GO_TO_ARTICLE = new Command( Locale.get(210), Command.SCREEN, 2 );
	...
	public RssTagHandler(Command linkCommand, ItemCommandListener listener)
	{
		...
		//#ifdef polish.i18n.useDynamicTranslations
			if ( Locale.get(211) != CMD_RSS_ITEM_SELECT.getLabel()) {
				CMD_RSS_ITEM_SELECT = new Command( Locale.get(211), Command.OK, 1 );
				CMD_GO_TO_ARTICLE = new Command( Locale.get(210), Command.SCREEN, 2 );
			}
		//#endif
	}
