...
public class TabBar extends Item {
	...
	public TabBar(String[] tabNames, Image[] tabImages, Style style) {
		...
		//#if !polish.LibraryBuild
			...
			this.activeStyle = (de.enough.polish.ui.StyleSheet.activetabStyle );
			//#style activefocusedtab, activetab, tab, default
			this.activeFocusedStyle = (de.enough.polish.ui.StyleSheet.activetabStyle );
			//#style inactivetab, tab, default
			this.inactiveStyle = (de.enough.polish.ui.StyleSheet.inactivetabStyle );
		//#endif
