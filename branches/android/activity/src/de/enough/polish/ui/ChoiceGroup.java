...
//#endif
{
	//#ifndef tmp.suppressMarkCommands
		//#ifdef polish.i18n.useDynamicTranslations
			public static Command MARK_COMMAND = new Command( Locale.get(181), Command.ITEM, 9 );
		...
		//#endif
		//#ifdef polish.i18n.useDynamicTranslations
			public static Command UNMARK_COMMAND = new Command( Locale.get(187), Command.ITEM, 9 );
		//#elifdef polish.command.mark:defined
		...
		//#ifndef tmp.suppressAllCommands
			if (this.choiceType == Choice.MULTIPLE) {
				...
				//#if !tmp.suppressSelectCommand
					...
					//#endif
						//#ifdef polish.i18n.useDynamicTranslations
							//# String cmdLabel = Locale.get(184);
