...
//#endif
{
	...
	//#ifdef polish.i18n.useDynamicTranslations
			public static Command CLEAR_CMD = new Command( Locale.get(176), Command.ITEM, CLEAR_PRIORITY );
	...
	//#ifndef tmp.suppressCommands
		...
		//#if polish.MenuBar.useExtendedMenuBar && polish.key.ReturnKey:defined
			//#ifdef polish.i18n.useDynamicTranslations
				public static Command DELETE_CMD = new Command( Locale.get(177), Command.ITEM, DELETE_PRIORITY );
		...
		//#else
			//#ifdef polish.i18n.useDynamicTranslations
				//# public static Command DELETE_CMD = new Command( Locale.get(177), Command.CANCEL, DELETE_PRIORITY );
			//#elifdef polish.command.delete:defined
	...
	//#if polish.key.maybeSupportsAsciiKeyMap
		...
		//#endif
		//# private static Command SWITCH_KEYBOARD_CMD = new Command (Locale.get(186), Command.ITEM, SWITCH_KEYBOARD_PRIORITY);
	//#endif
...
//# 				
			//#ifdef polish.i18n.useDynamicTranslations
				//# public static Command ENTER_SYMBOL_CMD = new Command( Locale.get(178), Command.SCREEN, ENTER_SYMBOL_PRIORITY );
...
//# 			
		...
		if(!this.suppressCommands)
		{
			...
			//#if (polish.TextField.suppressDeleteCommand != true) && !polish.blackberry
				if (!this.isUneditable)  {
					//#ifdef polish.i18n.useDynamicTranslations
						String delLabel = Locale.get(177);
			...
			//#if polish.TextField.suppressClearCommand != true
				if (!this.isUneditable) {
					//#ifdef polish.i18n.useDynamicTranslations
						String clearLabel = Locale.get(176);
			...
			//#if tmp.directInput && tmp.supportsSymbolEntry && polish.TextField.suppressAddSymbolCommand != true
				//# if (!this.isNumeric) {
					//# if (!this.isUneditable) {
						//#ifdef polish.i18n.useDynamicTranslations
							//# String enterSymbolLabel = Locale.get(178);
